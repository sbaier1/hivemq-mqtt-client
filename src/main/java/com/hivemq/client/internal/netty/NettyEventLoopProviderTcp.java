 ...
 */
@ThreadSafe
public class NettyEventLoopProviderTcp {

    private static final @NotNull InternalLogger LOGGER = InternalLoggerFactory.getLogger(NettyEventLoopProviderTcp.class);

    public static final @NotNull NettyEventLoopProviderTcp INSTANCE;
    ...
    private static NettyEventLoopProviderTcp nioEventLoopProvider() {
        return new NettyEventLoopProviderTcp(NioEventLoopGroup::new, NioSocketChannel::new);
    }

    private static class EpollHolder {

        private static NettyEventLoopProviderTcp eventLoopProvider() {
            if (Epoll.isAvailable()) {
                return new NettyEventLoopProviderTcp(EpollEventLoopGroup::new, EpollSocketChannel::new);
            } else {
    ...
    private NettyEventLoopProviderTcp(
